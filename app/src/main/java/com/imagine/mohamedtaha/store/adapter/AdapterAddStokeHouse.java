...
public class AdapterAddStokeHouse extends RecyclerView.Adapter<AdapterAddStokeHouse.StokeWearhouseViewHolder> {
    ...
    private ArrayList<ShowStockWare> itemStokeHouses;
    ...
    public AdapterAddStokeHouse(Context context, ArrayList<ShowStockWare> itemStokeHouses) {
...
//        holder.codeTypeStoreView.setText(data.getStoreId() +"");
        ...
        holder.firstBalanceView.setText(String.valueOf(data.getFirstBalance()));
...
*/
    ...
    public void setFilter(ArrayList<ShowStockWare> itemStoke) {
