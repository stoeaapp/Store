...
public class AdapterReportStore extends RecyclerView.Adapter<AdapterReportStore.ReportStoreViewHolder> {
    ...
    public static class RecycleTouchListener implements RecyclerView.OnItemTouchListener{
        ...
        private AdapterReportStore.ClickListener clickListener;

        public RecycleTouchListener(Context context, final RecyclerView recycleView, final AdapterReportStore.ClickListener clickLstener)
        {
